...
We use reqeusts.get to retrieve result and then write content of the response message to file. Then we use dataframe to read file .csv.gz and print sample data to console.
```python
